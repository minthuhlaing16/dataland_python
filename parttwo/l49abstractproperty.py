...
# todo ==> Abstract Readonly Property
...
# developerObj.id = 1002  #! error ==> @property loa ma pyaw yin ya tal ==> AttributeError: property 'id' of 'Developer' object has no setter
print(developerObj.id)


# todo ==> Abstract Read/Write property (Getter/Setter)
